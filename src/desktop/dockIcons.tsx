...
const iosDockGlyphSvgStyle = { width: 22, height: 22, display: 'block' as const }

/** Stroke sun / filled moon for the iOS dock theme control (uses currentColor). */
export function IosDockThemeGlyph({ mode }: { mode: 'sun' | 'moon' }): ReactElement {
  if (mode === 'sun') {
    return (
      <svg
        viewBox="0 0 24 24"
        ...
        style={iosDockGlyphSvgStyle}
        aria-hidden
      >
        <circle cx="12" cy="12" r="4" />
        <path d="M12 2v2M12 20v2M4.93 4.93l1.41 1.41M17.66 17.66l1.41 1.41M2 12h2M20 12h2M19.07 4.93l-1.41 1.41M4.93 19.07l1.41-1.41" />
      </svg>
    )
  }
  return (
    <svg viewBox="0 0 24 24" style={iosDockGlyphSvgStyle} aria-hidden>
      <path
        fill="currentColor"
